...
if __name__ == "__main__":
    ...
    if args.runexisting:
        run_string = f"pipenv run python scenarios/manylink_epp/run_manylink_epp.py --runexisting {subcase_path} {case}"
    else:
        run_string = f"pipenv run python scenarios/manylink_epp/run_manylink_epp.py {subcase_path} {case}"
    if args.bundle == 1:
...
{environment_setup_string}
pipenv run python scenarios/manylink_epp/run_manylink_epp.py --collect {subcase_path} {case}
"""

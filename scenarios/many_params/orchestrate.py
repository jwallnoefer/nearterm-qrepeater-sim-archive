...
base_path = os.path.join("results", "many_params")
...
if __name__ == "__main__":
    ...
    if args.runexisting:
        run_string = f"pipenv run python scenarios/many_params/run_many_params.py --runexisting {subcase_path} {case}"
    else:
        run_string = f"pipenv run python scenarios/many_params/run_many_params.py {subcase_path} {case}"
    if args.bundle == 1:
...
{environment_setup_string}
pipenv run python scenarios/many_params/run_many_params.py --collect {subcase_path} {case}
"""
